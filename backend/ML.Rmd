...
# RMSE for benchmark OLS: 0.134601734113644
```
...
# RMSE for Regression Trees: 0.183065940719009
```
...
# RMSE for Random Forest (trees: 500): 0.0596255499215339
# RMSE for Random Forest: (trees: 1000) 0.0596221301154754

# We pick ntree = 500 as our tuning parameter given the faster runtime, as the improvement in RMSE by using ntree = 1000 is negligible (only 0.0001 improvement)
```
...
# RMSE for Random Forest: 0.0596187125408457 
```
...
print("Best number of trees:", best_ntree, "\n")
print("Best interaction depth:", best_interaction_depth, "\n")
print("Best cross-validated MSE:", best_performance, "\n")
...
#RMSE for GBM: 0.0910988932316018
```
