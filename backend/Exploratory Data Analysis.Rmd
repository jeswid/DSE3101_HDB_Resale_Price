...
>>>>>>> 091ea5d6d3ba6d6132df9d31cdddbf03667ee3d5
```
...
# Assuming you have a dataset named `hdb_data` containing the variables for which you want to calculate VIF
...
calculate_vif <- function(correlation_matrix) {
  diag_inv <- 1/diag(correlation_matrix)
  vif <- diag_inv^2
  return(vif)
}

# Apply the function to calculate VIF
vif <- calculate_vif(correlation_matrix)
